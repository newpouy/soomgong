package com.plainit.soomgong.activity;
...
public class MapsActivity extends FragmentActivity {
    ...
    private void setUpMapIfNeeded() {
        ...
        latlngArray = intent.getDoubleArrayExtra("latlng");
        if (mMap == null) {
            ...
            mapFragment.getMapAsync(new OnMapReadyCallback() {
                ...
                public void onMapReady(GoogleMap googleMap) {
                    googleMap.addMarker(new MarkerOptions().position(new LatLng(latlngArray[0], latlngArray[1])).title("Marker"));
                }
            });
